...
const DISMISS_KEY = "trammos_conductor_install_banner_dismissed_at";
...
export function InstallAppBanner() {
    ...
    return (
      ...
      >
        ...
        <div className="text-xs text-foreground">
          Estás usando TRAMMOS Conductor como app instalada. ¡Listo!
        </div>
      </section>
    );
  }
  ...
  return (
    <>
      <section
        aria-label="Instalar TRAMMOS Conductor como aplicación"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground mt-1 leading-snug">
              {deferred
                ? "Toca instalar y tendrás la app del conductor en tu pantalla de inicio."
                : "Acceso directo a tus servicios desde la pantalla de inicio, sin abrir el navegador."}
            </p>
