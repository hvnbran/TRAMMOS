    ...
    return (
      ...
      >
        ...
        <div className="flex-1 text-xs text-foreground">
          Recibirás avisos cuando te asignen un nuevo servicio o cambien tus rutas.
        </div>
        <button
          type="button"
          onClick={unsubscribe}
    ...
    return (
      ...
      >
        ...
        <div className="text-xs text-foreground leading-snug">
          Las notificaciones están bloqueadas. Actívalas desde los ajustes del navegador para recibir avisos de nuevos servicios.
        </div>
      </section>
    );
  }
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-sm font-bold text-foreground leading-tight">
            Avísame cuando me asignen un servicio
          </h3>
          <p className="text-xs text-muted-foreground mt-1 leading-snug">
            Recibe una notificación cuando te asignen un nuevo servicio o cambien tus rutas, aunque tengas la app cerrada.
          </p>
          <button
            type="button"
            onClick={subscribe}
